    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <div class="row g-1 small">
                ...
                {{-- Tampilkan pengaju (Admin Akademik biasanya) --}}
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('kalender-akademik.show-doc', $doc->id) }}" class="btn btn-sm btn-outline-primary">
                ...
                @php
                    ...
                    switch ($doc->type) {
                        case 'kalender_akademik':
                            $urlPrint = route('kalender-akademik.print', $doc->id);
                            break;
                    }
                @endphp
