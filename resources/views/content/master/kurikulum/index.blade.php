...
<div class="card">
  ...
  <div class="card-header border-bottom">
    <div class="row">
        ...
        <div class="col-6 text-end">
            <button class="btn btn-primary add-new" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddKurikulum" id="btnCreate">
    ...
    <table class="table border-top" id="tableUser">
      ...
      <tbody>
        ...
        <tr >
            <td>{{ ++$key }}</td>
            <td>
                <p class="mb-0"><a href="#" class="text-body text-truncate">{{ $kurikulum->name }}</a></p>
            ...
            <td>
                <div class="d-flex align-items-center">
                    ...
                    <a href="javascript:;" class="text-body edit-record me-2"
                       ...
                       data-bs-target="#offcanvasAddKurikulum"
                       data-id="{{ $kurikulum->id }}"
                       data-name="{{ $kurikulum->name }}"
                       data-prodi-id="{{ $kurikulum->prodi_id }}"
                    ...
                    <form action="{{ route('master.kurikulum.destroy', $kurikulum->id) }}" method="POST" class="d-inline delete-form">
                        @csrf
                        @method('DELETE')
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddKurikulum" aria-labelledby="offcanvasAddKurikulumLabel">
    ...
    <div class="offcanvas-body mx-0 grow-0 p-6 h-100">
      ...
      <form class="add-new-kurikulum pt-0" id="addNewKurikulumForm" action="{{ route('master.kurikulum.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="add-name-kurikulum" placeholder="Contoh: A, B, C" name="name" value="{{ old('name') }}" />
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" type="date" value="{{ old('tanggal', date('Y')) }}" id="Tanggal">
            @error('tanggal') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
        <div class="mb-3">
            <label for="formFile" class="form-label">Masukan File Kurikulum</label>
            <input class="form-control @error('file_sk') is-invalid @enderror" name="file_sk" type="file" id="formFile">
