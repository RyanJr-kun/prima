...
<div class="card">
  ...
  <div class="card-header border-bottom">
    <div class="row">
        ...
        <div class="col-6 text-end">
            <button class="btn btn-primary add-new" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddCourse" id="btnCreate">
        ...
        <tr >
            ...
            <td>
                <div>
                    ...
                    <small class="text-xs text-truncate">Prodi : {{ $matkul->kurikulum->prodi->jenjang }} {{ $matkul->kurikulum->prodi->code }} </small>
                </div>
            </td>
            ...
            <td>
                <div class="d-flex align-items-center">
                    ...
                    <a  href="javascript:;" class="text-body edit-record me-2"
                        class="text-body edit-record me-2"
                        data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasAddCourse"
                        data-id="{{ $matkul->id }}"
                        data-code="{{ $matkul->code }}"
                        data-name="{{ $matkul->name }}"
                    ...
                    <form action="{{ route('master.mata-kuliah.destroy', $matkul->id) }}" method="POST" class="d-inline delete-form">
                        @csrf
                        @method('DELETE')
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCourse" aria-labelledby="offcanvasAddCourseLabel">
    ...
    <div class="offcanvas-body mx-0 grow-0 p-6 h-100">
      ...
      <form class="add-new-course pt-0" id="addNewCourseForm" action="{{ route('master.mata-kuliah.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label class="form-label" for="code">Kode</label>
            <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" placeholder="TRPL" name="code" value="{{ old('code') }}" />
            @error('code') 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="add-name-course" placeholder="Contoh: Pemrograman Web I" name="name" value="{{ old('name') }}" />
            @error('name')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('sks_teori') is-invalid @enderror" id="add-sks-teori" placeholder="3" name="sks_teori" value="{{ old('sks_teori') }}"/>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control @error('sks_praktik') is-invalid @enderror" 
                       id="add-sks-praktik" placeholder="5" name="sks_praktik" value="{{ old('sks_praktik') }}" />
            ...
            <div class="col-md-4 mb-3"> 
                ...
                <input type="number" class="form-control @error('sks_lapangan') is-invalid @enderror" 
                       id="add-sks-lapangan" placeholder="1" name="sks_lapangan" value="{{ old('sks_lapangan') }}" />
                @error('sks_lapangan') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
        </div>
        <div class="mb-3">
